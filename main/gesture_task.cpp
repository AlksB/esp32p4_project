...
extern "C" int gesture_task_run(const uint8_t *rgb888, int width, int height)
{
    ...
    ESP_LOGI(TAG, "cat=%s score=%.3f label=%d", best.cat_name, best.score, label);
    return label;
}
